%% BMED 4813 BHI: SIR MODEL V1(CYRUS) 
...
plot(t-100,xa(:,2)+xa(:,3),'LineWidth',3);
plot(t-100,xa(:,4),'LineWidth',3);
legend('Susceptibles','Infectious','Recovered');
xlabel('Time (Days)','FontSize',20);
ylabel('Population','FontSize',20);
set(gca, 'LineWidth',2,'FontSize',15);

I_eqn   = cumsum(xa(:,2)+xa(:,3));
