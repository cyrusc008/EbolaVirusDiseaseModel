...
N    = 2041;          %fit is 3900, normal is 1500000
E    = 32;
I    = I_eqn_1(a,end)/2;
H    = 0.8;
R    = 1.6;
...
%legend('Infected (CDC Data)','Infected (Hybrid Model)','Infected (Median)','Model Switch Date: Median','Model Switch Date: 1?','Location','southeast');
xlabel('Time (Days)','FontSize',20);
ylabel('Total Cases','FontSize',20);
title('Guinea 2014-16');
set(gca, 'LineWidth',2,'FontSize',15);
xlim([0 700]);
ylim([0 5000]);