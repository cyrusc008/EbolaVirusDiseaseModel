...
p_estimate = fminsearch(@(par)RMSE(tspan,I_real_2,par, S, E, I, H, R, F, D),[N beta_IR beta_ID beta_HR beta_HD beta_F theta alpha e_1 e_2 k_2 k_1 pie roe delta gamma], options);
...
tspan = linspace(max(tt_1),max(tt_2),146);
